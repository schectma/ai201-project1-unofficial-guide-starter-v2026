...
QUESTIONS = [
    # {"question": "...", "expects": "..."},
    {"question": "Through what week can I add a course?", "expects": "The second week."},
    {"question": "Through what week can we drop a course?", "expects": "The sixth week."},
    {"question": "What letter grade shows on the transcript if a drop occurs after week 2?", "expects": "W"},
    {"question": "Does the registrar's site explain add/drop deadlines?", "expects": "No."},
    {"question": "Where can students learn about add/drop deadlines?", "expects": "From each other."},
]
